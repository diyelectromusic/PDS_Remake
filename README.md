...
The original Intellectual Property was owned by Programmers Development Systems Ltd.  This new design has been put together from information obtained from the Internet aiming to support retro enthusiasts who are not able to obtain original working hardware.

This repository will remain private until the IP and licensing situation of the included files has been established.
